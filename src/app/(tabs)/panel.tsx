...
export default function PanelScreen() {
  ...
  const overallText =
    m.overallCompliance.kind === 'datos-insuficientes' ? 'Datos insuficientes' : `${Math.round(m.overallCompliance.pct * 100)}%`;
    ...
    <Screen>
      ...
      <Card>
        <View style={styles.rowBetween}>
          ...
          <Text style={styles.bigValue}>{overallText}</Text>
        </View>
      </Card>

      <Card>
        <CardKicker>Recomendación semanal</CardKicker>
